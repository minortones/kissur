/*
	...
	Used as is, except for commented-out/replaced headers
*/
...
VECTOR3 Matrix4x4::TransformCoord( const VECTOR3 & vec ) const
{
	return VECTOR3( vec.x * m11 + vec.y * m21 + vec.z * m31 + m41, 
...
{
	return VECTOR3( vec.x * m11 + vec.y * m21 + vec.z * m31, 
...
VECTOR3 Matrix4x4::Transform( const VECTOR3 & vec ) const
{
	...
	{
		return VECTOR3( trans.x / trans.w, trans.y / trans.w, trans.z / trans.w );
	}
