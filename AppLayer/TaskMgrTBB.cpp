...
//
class TaskSetTbb : public tbb::task
{
public:
    TaskSetTbb() 
    : mpFunc( NULL )
...
TaskMgrTbb::TaskMgrTbb()
    : mpTbbContextId( NULL )
    , mpTbbInit( NULL )
    , miDemoModeTBBThreadCountOverride( tbb::task_scheduler_init::automatic )
{
    memset(
        mSets,
        0x0,
...
BOOL TaskMgrTbb::Init()
{
    ...
    mpTbbInit = new tbb::task_scheduler_init( miDemoModeTBBThreadCountOverride );
...
BOOL TaskMgrTbb::CreateTaskSet( TASKSETFUNC             pFunc,
								VOID*                   pArg,
								UINT                    uTaskCount,
...
VOID TaskMgrTbb::ReleaseHandle( TASKSETHANDLE hSet )
{
...
VOID TaskMgrTbb::ReleaseHandles( TASKSETHANDLE* phSet, UINT uSet )
{
...
VOID TaskMgrTbb::WaitForSet( TASKSETHANDLE hSet )
{
    //
...
TASKSETHANDLE TaskMgrTbb::AllocateTaskSet()
{
    TaskSetTbb*         pSet = new( tbb::task::allocate_root() ) TaskSetTbb();
...
VOID TaskMgrTbb::CompleteTaskSet( TASKSETHANDLE hSet )
{
